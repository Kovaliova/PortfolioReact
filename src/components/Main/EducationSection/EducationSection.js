...
const EducationSection = ({iconBook, iconCap}) => (
    <div className="container">
        <Font family='Poppins'>
            <h1 className='label'>Education & courses</h1>
        </Font>
        <div className="wrapper-card">
          ...
          <div className="wrapper-card--courses">
            ...
            <div className="card">
                ...
                <p style={{marginBottom: 0}}>Training course "Website development using HTML, CSS and JavaScript" in 2018 year. In-depth and advanced site development</p>
            </div>
            <ShowMore 
                maxHeight={70}
            ...
            >
            <div className="card" style={{paddingTop: 25 + "px"}}>
                <h3>IT-ACADEMY (HIGH-TECH PARK EDUCATION CENTER)</h3>
            ...
            <div className="card">
                ...
                <p style={{marginBottom: 0}}>Independent study of this course and application of the acquired knowledge in practice. Passing the test, receiving a certificate of successful completion of the test in 2023.</p>
            </div>  
            </ShowMore>
          </div>
        </div>
